...
public class DateUtil {
	...
	public static String utilChangeSql(java.util.Date date) {
	...
	/**
	 * @Title: getCurrentTime @Description: 获取当前的系统时间，格式化为yyyy-MM-dd
	 * HH:mm:ss @return String @throws
	 */
	...
	/**
	 * @Title: getCurrentTime @Description:获取当前的系统时间 @param @param format
	 * 时间格式(例如：yyyy-MM-dd HH:mm:ss;yyyy-MM-dd;yyyy/MM) @return String 返回类型 @throws
	 */
	...
	/**
	 * @Title: getCurrentDate @Description: 获取当前的系统时间 @param @throws ParseException
	...
	/**
	 * @Title: getCurrentTimeStamp @Description: 获取当前的系统时间 @param @return
	 * 参数说明 @return Timestamp 返回类型 @throws
	 */
	...
	/**
	 * @Title: getDateforDiffs @Description: 获取某个指定时间的偏差天数的日期 @param @param
	 * startDateTime 指定开始日期，如没有，，就从1970年1月1日开始算起 @param @param interval
	 * 相差天数 @param @param format 时间格式 如： yyyy-MM-dd
	 * HH:mm:ss @param @return @param @throws ParseExcption 参数说明 @return Date
	 * 返回类型 @throws
	 */
	...
	/**
	 * @Title: getFormatTime @Description: 时间戳转日期格式,格式化为yyyy-MM-dd
	 * HH:mm:ss @param @param times @param @return 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * @Title: getFormatTime @Description: 时间戳转日期格式 @param @param
	 * times @param @param format 时间格式(例如：yyyy-MM-dd
	 * HH:mm:ss;yyyy-MM-dd;yyyy/MM) @param @return 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * @Title: getFormatGMTTime @Description:转换格林威治时间为普通时间 @param @param
	 * timeStr @param @param format 指定输出格式 @return String 返回类型 @throws
	 */
